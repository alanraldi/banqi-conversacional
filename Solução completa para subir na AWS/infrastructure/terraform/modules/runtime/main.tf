# -----------------------------------------------------------------------------
# AgentCore Runtime — container ARM64 (Graviton)
# Recursos: ECR repository + null_resource build/push + AgentCore Runtime + Endpoint
# -----------------------------------------------------------------------------
...
# =============================================================================
# Container build + push (local-exec — roda na máquina que executa terraform)
# Requer: Docker + AWS CLI configurados localmente
# =============================================================================
...
output "runtime_arn"      { value = aws_bedrockagentcore_agent_runtime.this.arn }
output "runtime_endpoint" { value = aws_bedrockagentcore_agent_runtime_endpoint.this.endpoint_url }
output "ecr_repo_url"     { value = aws_ecr_repository.runtime.repository_url }
...
variable "network_mode"          { type = string; default = "PUBLIC" }
